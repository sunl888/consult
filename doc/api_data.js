define({ "api": [
  {
    "type": "GET",
    "url": "/admin/issue/delete/:issue_id",
    "title": "对某个问题强制删除",
    "group": "Admin",
  ...
  {
    "type": "GET",
    "url": "/admin/issue/list_softdel/:offset/:limit",
    "title": "分页显示被软删除的问题",
    "group": "Admin",
  ...
  },
  {
    ...
    "sampleRequest": [
      {
        "url": "http://api.consult.dev/admin/issue/lists/offset=:offset/limit=:limit"
      }
    ]
  },
  {
    "type": "GET",
    "url": "/admin/issue/restore/:issue_id",
    "title": "恢复被软删除的问题",
    "group": "Admin",
  ...
  {
    "type": "GET",
    "url": "/admin/issue/softdelete/:issue_id",
    "title": "对某个问题软删除",
    "group": "Admin",
